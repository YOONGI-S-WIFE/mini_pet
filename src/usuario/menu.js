...
export class menuUsuario extends LitElement {
  ...
  <div>
    ...
    actualizar_mascota(y, id_mascota) {
      ...
      <br /><br />
      <button class="btn btn-dark d-flex m-1 font" @click="${(e) => this.update_mascota(this.mascota_especifica)}">Actualizar<i class="fas fa-plus fa-beat-fade"></i></button>
    </div>
  ...
  customElements.define('menuUsuario', menuUsuario)