...
import { usuario } from "./usuario/menuUsuario";
          ...
          <div class="main">
              <div class="container text-center d-flex justify-content-center align-items-center">
                ...
                <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Username" aria-label="Username" value="${
                        this.email
                      }" @input="${(e) =>
  ...
  iniciarSesion() {
    ...
    if (usuarioValido) {
      ...
      if (dominio === "minipet.com") {
        ...
        const MenuUsu = document.createElement("usuario-element");
        document.body.innerHTML = "";
          ...
          <div class="content rounded">
            <div class="m-3">
              ...
              <input
                ...
                .value="${this.apellido}"
                @input="${(e) =>
                  (this.apellido = e.target.value)}" /><br /><br />
              ...
              <div class="card m-3" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <img
                    ...
                    class="w-75" />
                  <p class="card-text">
                    Estos perritos son unos gordos sachicha que rescatamos a la
